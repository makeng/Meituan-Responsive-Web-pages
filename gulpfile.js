...
//文件移动 -----------------------------------------------------------------------------
/*---一个对象需要把index加1-------*/
makeObj( "moveHtml", "meituan/src/*.html", "meituan/build" );
makeObj( "moveImg", "meituan/src/img/*", "meituan/build/img" );
makeObj( "moveJs", "meituan/src/js/*.js", "meituan/build/js" );
makeObj( "moveCss", "meituan/src/css/*", "meituan/build/css" );
//文件移动
for ( var i = 0; i < arrObj.length; i ++ ){	//文件移动的集中处理
	moveFiles( arrObj[i].name, arrObj[i].source, arrObj[i].target1 );
}
//less转换-----------------------------------------------------------------------------------------
makeObj( "less2css", "meituan/src/less/*.less", "meituan/src/css", "meituan/build/css" );
lessToCss( arrObj[index].name, arrObj[index].source, arrObj[index].target1, arrObj[index].target2 );
//js转换-------------------------------------------------------------------------------------------
makeObj( "jsOpt", "meituan/src/js_my/*.js", "meituan/src/js", "meituan/build/js", "main.js" );
